...
export default function Example() {
  return (
    <Disclosure as="nav" className="bg-white shadow z-index-2">
      {({ open }) => (
        <>
            ...
            <div className="relative flex items-center justify-between h-16">
              ...
              <div className="flex-1 flex items-center  sm:items-stretch sm:justify-start">
                <div className="flex-shrink-0 flex items-center">
                    <p>Starbucks </p> &nbsp;
                   <ChevronDownIcon className="block h-3 w-3" aria-hidden="true" />
                </div>
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <div className='sm:block sm:ml-2'>
                <p className='inline'>John</p> &nbsp;
                   <ChevronDownIcon className="block h-3 w-3 inline" aria-hidden="true" />
                </div>
              </div>
            </div>
          </div>
